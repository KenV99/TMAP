...
function tmap-setup() {
   ...
   echo "If you will be installing TM please edit your VM Settings-Options-Shared Folders to include a shared folder for TM before rebooting"
   echo "Press ENTER to reboot.${reset}"
   read TMP
}
